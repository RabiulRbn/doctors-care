                ...
                <Carousel className="banner-container mx-auto">
                    <Carousel.Item>
                        ...
                        <Carousel.Caption className="caption1">
                            <h3>Modern And Latest Technology Treatment</h3>
                    ...
                    <Carousel.Item>
                        ...
                        <Carousel.Caption className="caption2">
                            <h3>We Have Highly Experienced Doctor In Our Hospital</h3>
                            <p>Our Service And Work Efficiency Are The Reasons For Success.</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img
                        ...
                        <Carousel.Caption className="caption3">
                            <h3>Mediva Health, Keeping Care Close To Home</h3>
